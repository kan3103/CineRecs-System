...
const Like = ({ movieId, onLiked }) => {
    ...
    return (
        <StyledWrapper>
            <div className="like-wrapper" onClick={handleLikeClick}>
                <input className="check" type="checkbox" id={`like-toggle-${movieId}`} />
                <label className="container" htmlFor={`like-toggle-${movieId}`}>
